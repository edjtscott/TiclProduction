...
#from RecoHGCal.TICL.DummyStep_cff import filteredLayerClustersDummy
#from RecoHGCal.TICL.DummyStep_cff import ticlTrackstersDummy
#from RecoHGCal.TICL.DummyStep_cff import ticlMultiClustersFromTrackstersDummy

#process.iterTICLTask = cms.Task(process.ticlLayerTileTask
    #,process.ticlDummyStepTask
    #,process.ticlTrkEMStepTask
    #,process.ticlEMStepTask
    #,process.ticlTrkStepTask
    #,process.ticlHADStepTask
